...
{
    private readonly InMemoryDatabaseRoot _dbRoot = new InMemoryDatabaseRoot();//for consistent state for db
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            var descriptor = services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TennisBookingDbContext>));
            if (descriptor != null)
            {
